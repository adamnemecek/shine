...
#[derive(Clone)]
pub struct WindowSettings<EXTRA: Copy + Debug + Default> {
    /// Title of the window.
    pub title: String,
    ...
    /// Indicates to start in fullscreen mode.
    pub fullscreen: bool,

    /// Indicates if window can be resized.
    pub resizable: bool,

    /// Indicates if window decoration shall be enabled.
    pub decorated: bool,

    /// Frame buffer configuration.
    pub fb_config: FBConfig,

    /// Extra platform dependent config.
    pub platform_extra: EXTRA,

}

impl<EXTRA: Copy + Debug + Default> Default for WindowSettings<EXTRA> {
    ...
    /// - debug: false
    ///
    fn default() -> WindowSettings<EXTRA> {
        WindowSettings {
            title: "hello".into(),
...
impl<EXTRA: Copy + Debug + Default> WindowSettings<EXTRA> {
